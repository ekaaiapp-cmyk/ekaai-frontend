      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-8">
          ...
          <button
            ...
            className="w-full bg-white text-gray-900 px-6 py-4 rounded-lg font-semibold hover:bg-gray-50 transition-all duration-200 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center space-x-3 shadow-lg"
          >
            {isSigningIn ? (
              <>
